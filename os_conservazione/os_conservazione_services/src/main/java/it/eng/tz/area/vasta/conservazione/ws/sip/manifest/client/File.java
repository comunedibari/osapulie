...
/**
 * Percorso e impronta di un file che fa parte del SIP
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Path" type="{urn:IRIS:SIPManifest.xsd}Path"/&gt;
 *         &lt;element name="Hash"&gt;
 *           &lt;complexType&gt;
 *             &lt;simpleContent&gt;
 *               &lt;extension base="&lt;urn:IRIS:SIPManifest.xsd&gt;Hash"&gt;
 *               &lt;/extension&gt;
 *             &lt;/simpleContent&gt;
 *           &lt;/complexType&gt;
 *         &lt;/element&gt;
...
public class File {
     ...
     *     
     */
    public void setHash(File.Hash value) {
        this.hash = value;
    }
    ...
    public static class Hash
        extends it.eng.tz.area.vasta.conservazione.ws.sip.manifest.client.Hash
    {
