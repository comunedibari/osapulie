 ...
 *       &lt;attribute name="encoding" use="required" type="{urn:IRIS:SIPManifest.xsd}DigestEncoding" /&gt;
 *       &lt;attribute name="func" use="required" type="{urn:IRIS:SIPManifest.xsd}HashFunc" /&gt;
 *     &lt;/extension&gt;
 *   &lt;/simpleContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlSeeAlso({
    it.eng.tz.area.vasta.conservazione.ws.sip.manifest.client.File.Hash.class
})
public class Hash {

    @XmlValue
    protected String value;
    @XmlAttribute(name = "encoding", namespace = "urn:IRIS:SIPManifest.xsd", required = true)
    protected DigestEncoding encoding;
    @XmlAttribute(name = "func", namespace = "urn:IRIS:SIPManifest.xsd", required = true)
