...
public class RegistroProtocolloModel implements Serializable {

	private static final long serialVersionUID = 7206974968420480567L;
	//private long idRegistroProtocollo;
	private String puntatoreAlfresco;
	//private Date dataCreazione;
//	/*
//	 * 1 --> file generato correttamente
//	 * 0 --> file non generato
//	 * */
...
//	private int anno;
//	private int numeroPrimaReg;
//	private int numeroUltimaReg;
...
//	private Date dataUltimaReg;
	...
	public String toString() {
		return "RegistroProtocolloModel [idRegistroProtocollo=" + idRegistroProtocollo + ", puntatoreAlfresco="
				+ puntatoreAlfresco + ", dataCreazione=" + dataCreazione + ", flagGenerato=" + flagGenerato
				+ ", pathFileSystem=" + pathFileSystem + ", fileName=" + fileName + ", destinatario=" + destinatario
				+ ", checkSum=" + checksum + ", codiceAmministrazione=" + codiceAmministrazione + ", codiceAoo="
				+ codiceAoo + ", soggettoProduttore2=" + soggettoProduttore2 + ", soggettoProduttore="
				+ soggettoProduttore + ", responsabile=" + responsabile + ", oggetto=" + oggetto + ", codiceRegistro="
				+ codiceRegistro + ", progressivo=" + progressivo + ", anno=" + anno + ", numeroPrimaReg="
				+ numeroPrimaReg + ", numeroUltimaReg=" + numeroUltimaReg + ", dataPrimaReg=" + dataPrimaReg
				+ ", dataUltimaReg=" + dataUltimaReg + "]";
	}
}
