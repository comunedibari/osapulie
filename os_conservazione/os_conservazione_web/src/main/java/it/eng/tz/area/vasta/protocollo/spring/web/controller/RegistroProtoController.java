...
@RestController
@RequestMapping("/rest")
public class RegistroProtoController {
	private static final Logger logger = LoggerFactory.getLogger(RegistroProtoController.class.getName());
...
//	private ISysconfigSvc sysConfigsvc;
	...
	@RequestMapping(method = { RequestMethod.GET }, value = { "/protected/ltsProto" }, produces = {
			"application/json" })
	...
	@RequestMapping(method = { RequestMethod.GET }, value = { "/protected/download" })
	...
	@RequestMapping(method = { RequestMethod.GET}, value = { "/protected/saveregistro" })
