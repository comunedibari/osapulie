...
<tiles:insertDefinition name="defaultTemplate">
	<tiles:putAttribute name="head">
		...
		<script src="<spring:url value="/resources/js/registro-audit.js" />"></script>
	...
	<tiles:putAttribute name="body">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body" style="padding: 0px;">
						...
						<div class="col-sm-12"
							...
							<div style="width: 100%; text-align: center; padding-top: 25px;"> TEST::
		...
		<div class="container"
			...
			<div class="row">
				<div class='col-sm-12'>
					<table id="tblSearchAudit" class="datatables-table table table-striped table-bordered table-hover" cellspacing="0" style="width: 100%">
