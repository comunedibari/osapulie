	...
	<aui:fieldset>
		<aui:column>
			...
			<c:if test="<%= !PrefsPropsUtil.getBoolean(company.getCompanyId(), PropsKeys.USERS_SCREEN_NAME_ALWAYS_AUTOGENERATE) %>">
				...
				<label class="aui-field-label" for="_58_screenName">
					<liferay-ui:message key="screen-name" />	
				</label>
				<input class="aui-field-input aui-field-input-text" id="_58_screenName" name="_58_screenName" style="width: 150px; " type="text" value="" maxlength="16">
			</c:if>
