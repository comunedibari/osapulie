...
<c:choose>
	...
	<c:otherwise>
		...
		<!-- Eliminata form di login di liferay in caso di CAS attivo-->
		
		<%
			if (!PrefsPropsUtil.getBoolean(company.getCompanyId(), PropsKeys.CAS_AUTH_ENABLED, PropsValues.CAS_AUTH_ENABLED)){
		%>
