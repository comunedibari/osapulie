 ...
 * @version $Revision: 1.2 $ $Date: 2006/06/21 12:48:10 $
 * @since 3.0.4
 */
        ...
        for (int i = 0; i < certificates.length; i++) {
            ...
            try {
                ...
                if (principal != null && log.isDebugEnabled()) {
                    ...
                    log.debug("No principal found within the certificate!");
                }

                if (principal != null 
                    //&& isCertificateFromTrustedIssuer(principal)
                     && doesCertificateSubjectDnMatchPattern( certificate.getSubjectDN() )) {
