...
/**
 * UsernamePasswordCredentials respresents the username and password that a user may provide in
 * order to prove the authenticity of who they say they are.
 * 
 * @author Scott Battaglia
 * @version $Revision$ $Date$
 * @since 3.0 <p>This is a published and supported CAS Server 3 API.</p>
 */
