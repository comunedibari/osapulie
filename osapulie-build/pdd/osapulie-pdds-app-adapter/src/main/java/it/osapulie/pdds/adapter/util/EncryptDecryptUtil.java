...
public class EncryptDecryptUtil {
	...
	public static String encrypt(String textToEncrypt, String passkey) throws NoSuchAlgorithmException, NoSuchProviderException, NoSuchPaddingException, InvalidKeyException,
	...
	public static String decrypt(String textToDecrypt, String passkey) throws NoSuchAlgorithmException, NoSuchProviderException, NoSuchPaddingException, InvalidKeyException,
			IllegalBlockSizeException, BadPaddingException {
		SecretKeySpec key = new SecretKeySpec(passkey.getBytes(), "AES");
		Cipher cipher = Cipher.getInstance("AES/ECB/PKCS5Padding", "SunJCE");
