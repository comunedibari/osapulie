...
import it.osapulie.pdds.ws.client.documenti.anagrafe.Documento;
import it.osapulie.pdds.ws.client.documenti.anagrafe.VisuraDocumentiAnagrafeServiceLocator;
import it.osapulie.pdds.ws.client.documenti.anagrafe.VisuraDocumentiAnagrafeServicePortType;

/**
 * Implementazione interna del servizio di Visura Documenti Anagrafe.
 *
 * @author Gianluca Pindinelli
 *
 */
public class VisuraDocumentiAnagrafeService implements PddService {

	private final Logger log = LoggerFactory.getLogger(VisuraDocumentiAnagrafeService.class);
	...
	private VisuraDocumentiRisposta risposta(VisuraDocumentiRichiesta richiesta) {
		...
		try {
			URL wsdlLocation = new URL(webservicesBaseUrl + "/services/visuraDocumentiAnagrafeService?wsdl");
			VisuraDocumentiAnagrafeServiceLocator visuraDocumentiServiceLocator = new VisuraDocumentiAnagrafeServiceLocator();
			VisuraDocumentiAnagrafeServicePortType secureSOAP11Endpoint = visuraDocumentiServiceLocator.getSecureSOAP11Endpoint(wsdlLocation);
	...
	public String getName() {
		return "visuraDocumentiAnagrafe";
	}
