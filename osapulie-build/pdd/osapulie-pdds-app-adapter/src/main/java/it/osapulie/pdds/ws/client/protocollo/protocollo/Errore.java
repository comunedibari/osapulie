...
public class Errore  implements java.io.Serializable {
    ...
    /**
     * Gets the descrizione value for this Errore.
     * 
     * @return descrizione
     */
    ...
    /**
     * Sets the descrizione value for this Errore.
     * 
     * @param descrizione
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://protocollo.linksmt.it/RichiestaSOAP", "Errore"));
