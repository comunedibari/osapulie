/**
 * RichiestaProtocolloProvvisorioProtocolloProvvisorioRequest.java
 *
...
public class RichiestaProtocolloProvvisorioProtocolloProvvisorioRequest  implements java.io.Serializable {
    ...
    public RichiestaProtocolloProvvisorioProtocolloProvvisorioRequest() {
    }
    ...
    /**
     * Gets the mittente value for this RichiestaProtocolloProvvisorioProtocolloProvvisorioRequest.
     * 
     * @return mittente
     */
    ...
    /**
     * Sets the mittente value for this RichiestaProtocolloProvvisorioProtocolloProvvisorioRequest.
     * 
     * @param mittente
     */
    ...
    /**
     * Gets the destinatari value for this RichiestaProtocolloProvvisorioProtocolloProvvisorioRequest.
     * 
     * @return destinatari
     */
    ...
    /**
     * Sets the destinatari value for this RichiestaProtocolloProvvisorioProtocolloProvvisorioRequest.
     * 
     * @param destinatari
     */
    ...
    /**
     * Gets the areaOrganizzativaOmogenea value for this RichiestaProtocolloProvvisorioProtocolloProvvisorioRequest.
     * 
    ...
    /**
     * Sets the areaOrganizzativaOmogenea value for this RichiestaProtocolloProvvisorioProtocolloProvvisorioRequest.
     * 
    ...
    /**
     * Gets the amministrazione value for this RichiestaProtocolloProvvisorioProtocolloProvvisorioRequest.
     * 
    ...
    /**
     * Sets the amministrazione value for this RichiestaProtocolloProvvisorioProtocolloProvvisorioRequest.
     * 
    ...
    /**
     * Gets the oggetto value for this RichiestaProtocolloProvvisorioProtocolloProvvisorioRequest.
     * 
     * @return oggetto
     */
    ...
    /**
     * Sets the oggetto value for this RichiestaProtocolloProvvisorioProtocolloProvvisorioRequest.
     * 
     * @param oggetto
     */
    ...
    /**
     * Gets the idUtente value for this RichiestaProtocolloProvvisorioProtocolloProvvisorioRequest.
     * 
     * @return idUtente
     */
    ...
    /**
     * Sets the idUtente value for this RichiestaProtocolloProvvisorioProtocolloProvvisorioRequest.
     * 
     * @param idUtente
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RichiestaProtocolloProvvisorioProtocolloProvvisorioRequest)) return false;
        RichiestaProtocolloProvvisorioProtocolloProvvisorioRequest other = (RichiestaProtocolloProvvisorioProtocolloProvvisorioRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RichiestaProtocolloProvvisorioProtocolloProvvisorioRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://server.ws.protocollo.linksmt.it/", ">richiestaProtocolloProvvisorio>protocolloProvvisorioRequest"));
