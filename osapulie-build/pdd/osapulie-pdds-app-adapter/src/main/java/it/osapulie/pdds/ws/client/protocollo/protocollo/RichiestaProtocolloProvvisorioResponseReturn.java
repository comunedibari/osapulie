/**
 * RichiestaProtocolloProvvisorioResponseReturn.java
 *
...
public class RichiestaProtocolloProvvisorioResponseReturn  implements java.io.Serializable {
    ...
    public RichiestaProtocolloProvvisorioResponseReturn() {
    }
    ...
    /**
     * Gets the numeroProtocollo value for this RichiestaProtocolloProvvisorioResponseReturn.
     * 
    ...
    /**
     * Sets the numeroProtocollo value for this RichiestaProtocolloProvvisorioResponseReturn.
     * 
    ...
    /**
     * Gets the anno value for this RichiestaProtocolloProvvisorioResponseReturn.
     * 
     * @return anno
     */
    public int getAnno() {
    ...
    /**
     * Sets the anno value for this RichiestaProtocolloProvvisorioResponseReturn.
     * 
     * @param anno
     */
    ...
    /**
     * Gets the dataProtocollo value for this RichiestaProtocolloProvvisorioResponseReturn.
     * 
    ...
    /**
     * Sets the dataProtocollo value for this RichiestaProtocolloProvvisorioResponseReturn.
     * 
    ...
    /**
     * Gets the errore value for this RichiestaProtocolloProvvisorioResponseReturn.
     * 
     * @return errore
     */
    ...
    /**
     * Sets the errore value for this RichiestaProtocolloProvvisorioResponseReturn.
     * 
     * @param errore
     */
    ...
    /**
     * Gets the mittente value for this RichiestaProtocolloProvvisorioResponseReturn.
     * 
     * @return mittente
     */
    ...
    /**
     * Sets the mittente value for this RichiestaProtocolloProvvisorioResponseReturn.
     * 
     * @param mittente
     */
    ...
    /**
     * Gets the destinatari value for this RichiestaProtocolloProvvisorioResponseReturn.
     * 
     * @return destinatari
     */
    ...
    /**
     * Sets the destinatari value for this RichiestaProtocolloProvvisorioResponseReturn.
     * 
     * @param destinatari
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RichiestaProtocolloProvvisorioResponseReturn)) return false;
        RichiestaProtocolloProvvisorioResponseReturn other = (RichiestaProtocolloProvvisorioResponseReturn) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RichiestaProtocolloProvvisorioResponseReturn.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://server.ws.protocollo.linksmt.it/", ">richiestaProtocolloProvvisorioResponse>return"));
