...
public class Classifica  implements java.io.Serializable {
    private it.osapulie.pdds.ws.client.protocollo.ricercaDoc.ListaLivelli livelli;
    ...
    public Classifica(
           it.osapulie.pdds.ws.client.protocollo.ricercaDoc.ListaLivelli livelli,
     ...
     * @return livelli
     */
    public it.osapulie.pdds.ws.client.protocollo.ricercaDoc.ListaLivelli getLivelli() {
        return livelli;
    }
     ...
     * @param livelli
     */
    public void setLivelli(it.osapulie.pdds.ws.client.protocollo.ricercaDoc.ListaLivelli livelli) {
        this.livelli = livelli;
    }
