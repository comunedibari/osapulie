...
public class EstremiProtocolloEstesi  implements java.io.Serializable {
    private it.osapulie.pdds.ws.client.protocollo.ricercaDoc.EstremiProtocollo estremiProtocollo;
    ...
    public EstremiProtocolloEstesi(
           it.osapulie.pdds.ws.client.protocollo.ricercaDoc.EstremiProtocollo estremiProtocollo,
     ...
     */
    public it.osapulie.pdds.ws.client.protocollo.ricercaDoc.EstremiProtocollo getEstremiProtocollo() {
        return estremiProtocollo;
    }
     ...
     */
    public void setEstremiProtocollo(it.osapulie.pdds.ws.client.protocollo.ricercaDoc.EstremiProtocollo estremiProtocollo) {
        this.estremiProtocollo = estremiProtocollo;
    }
