...
public class ListaDocumentiInformatici  implements java.io.Serializable {
    private it.osapulie.pdds.ws.client.protocollo.ricercaDoc.DocumentoInformatico[] documentoInformatico;

    public ListaDocumentiInformatici() {
    }

    public ListaDocumentiInformatici(
           it.osapulie.pdds.ws.client.protocollo.ricercaDoc.DocumentoInformatico[] documentoInformatico) {
     ...
     */
    public it.osapulie.pdds.ws.client.protocollo.ricercaDoc.DocumentoInformatico[] getDocumentoInformatico() {
        return documentoInformatico;
    }
     ...
     */
    public void setDocumentoInformatico(it.osapulie.pdds.ws.client.protocollo.ricercaDoc.DocumentoInformatico[] documentoInformatico) {
        this.documentoInformatico = documentoInformatico;
    }

    public it.osapulie.pdds.ws.client.protocollo.ricercaDoc.DocumentoInformatico getDocumentoInformatico(int i) {
        return this.documentoInformatico[i];
    }

    public void setDocumentoInformatico(int i, it.osapulie.pdds.ws.client.protocollo.ricercaDoc.DocumentoInformatico _value) {
