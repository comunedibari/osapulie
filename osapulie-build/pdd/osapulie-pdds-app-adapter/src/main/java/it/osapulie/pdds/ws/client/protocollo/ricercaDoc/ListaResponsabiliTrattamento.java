...
public class ListaResponsabiliTrattamento  implements java.io.Serializable {
    private it.osapulie.pdds.ws.client.protocollo.ricercaDoc.ResponsabileTrattamento[] responsabileTrattamento;

    public ListaResponsabiliTrattamento() {
    }

    public ListaResponsabiliTrattamento(
           it.osapulie.pdds.ws.client.protocollo.ricercaDoc.ResponsabileTrattamento[] responsabileTrattamento) {
     ...
     */
    public it.osapulie.pdds.ws.client.protocollo.ricercaDoc.ResponsabileTrattamento[] getResponsabileTrattamento() {
        return responsabileTrattamento;
    }
     ...
     */
    public void setResponsabileTrattamento(it.osapulie.pdds.ws.client.protocollo.ricercaDoc.ResponsabileTrattamento[] responsabileTrattamento) {
        this.responsabileTrattamento = responsabileTrattamento;
    }

    public it.osapulie.pdds.ws.client.protocollo.ricercaDoc.ResponsabileTrattamento getResponsabileTrattamento(int i) {
        return this.responsabileTrattamento[i];
    }

    public void setResponsabileTrattamento(int i, it.osapulie.pdds.ws.client.protocollo.ricercaDoc.ResponsabileTrattamento _value) {
