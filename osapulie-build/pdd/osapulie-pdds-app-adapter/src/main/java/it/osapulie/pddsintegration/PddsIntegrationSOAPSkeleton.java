...
public class PddsIntegrationSOAPSkeleton implements it.osapulie.pddsintegration.PddsIntegration_PortType, org.apache.axis.wsdl.Skeleton {
    private it.osapulie.pddsintegration.PddsIntegration_PortType impl;
    ...
    */
    ...
    public PddsIntegrationSOAPSkeleton() {
        this.impl = new it.osapulie.pddsintegration.PddsIntegrationSOAPImpl();
    }

    public PddsIntegrationSOAPSkeleton(it.osapulie.pddsintegration.PddsIntegration_PortType impl) {
        this.impl = impl;
    }
