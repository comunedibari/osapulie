...
public class PddsIntegration_ServiceLocator extends org.apache.axis.client.Service implements it.osapulie.pddsintegration.PddsIntegration_Service {
    ...
    public it.osapulie.pddsintegration.PddsIntegration_PortType getPddsIntegrationSOAP(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            it.osapulie.pddsintegration.PddsIntegrationSOAPStub _stub = new it.osapulie.pddsintegration.PddsIntegrationSOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (it.osapulie.pddsintegration.PddsIntegration_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                it.osapulie.pddsintegration.PddsIntegrationSOAPStub _stub = new it.osapulie.pddsintegration.PddsIntegrationSOAPStub(new java.net.URL(PddsIntegrationSOAP_address), this);
                _stub.setPortName(getPddsIntegrationSOAPWSDDServiceName());
                return _stub;
            }
        }
