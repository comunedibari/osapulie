 ...
 *
 */
public class DocumentiContenutiService extends CommonService implements PddService {

	private final Logger log = LoggerFactory.getLogger(DocumentiContenutiService.class);
