 ...
 *
 */
public class DownloadDocumentoService extends CommonService implements PddService {

	private final Logger log = LoggerFactory.getLogger(DownloadDocumentoService.class);
