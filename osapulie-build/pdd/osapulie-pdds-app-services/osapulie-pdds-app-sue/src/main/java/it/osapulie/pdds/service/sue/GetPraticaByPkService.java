 ...
 *
 */
public class GetPraticaByPkService extends CommonService implements PddService {

	private final Logger log = LoggerFactory.getLogger(GetPraticaByPkService.class);
