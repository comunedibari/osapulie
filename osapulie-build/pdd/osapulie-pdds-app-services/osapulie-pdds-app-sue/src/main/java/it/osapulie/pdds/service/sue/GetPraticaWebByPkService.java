 ...
 *
 */
public class GetPraticaWebByPkService extends CommonService implements PddService {

	private final Logger log = LoggerFactory.getLogger(GetPraticaWebByPkService.class);
