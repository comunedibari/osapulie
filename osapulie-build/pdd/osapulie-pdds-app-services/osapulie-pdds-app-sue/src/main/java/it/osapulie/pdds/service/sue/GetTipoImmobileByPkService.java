 ...
 *
 */
public class GetTipoImmobileByPkService extends CommonService implements PddService {

	private final Logger log = LoggerFactory.getLogger(GetTipoImmobileByPkService.class);
