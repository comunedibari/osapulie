 ...
 *
 */
public class GetTipoPraticaByPkService extends CommonService implements PddService {

	private final Logger log = LoggerFactory.getLogger(GetTipoPraticaByPkService.class);
