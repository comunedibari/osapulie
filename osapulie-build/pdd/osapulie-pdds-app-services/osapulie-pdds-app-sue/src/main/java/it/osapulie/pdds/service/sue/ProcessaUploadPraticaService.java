 ...
 *
 */
public class ProcessaUploadPraticaService extends CommonService implements PddService {

	private final Logger log = LoggerFactory.getLogger(ProcessaUploadPraticaService.class);
