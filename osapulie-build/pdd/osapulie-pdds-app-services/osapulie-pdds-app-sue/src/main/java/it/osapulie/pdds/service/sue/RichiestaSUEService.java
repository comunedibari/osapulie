 ...
 *
 */
public class RichiestaSUEService extends CommonService implements PddService {

	protected Logger log = LoggerFactory.getLogger(RichiestaSUEService.class.getName());
