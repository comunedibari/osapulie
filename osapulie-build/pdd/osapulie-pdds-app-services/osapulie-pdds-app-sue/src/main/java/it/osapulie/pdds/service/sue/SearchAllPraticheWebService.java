 ...
 *
 */
public class SearchAllPraticheWebService extends CommonService implements PddService {

	private final Logger log = LoggerFactory.getLogger(SearchAllPraticheWebService.class);
