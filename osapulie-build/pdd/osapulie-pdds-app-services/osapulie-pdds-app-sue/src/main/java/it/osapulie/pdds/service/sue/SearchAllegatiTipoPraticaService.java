 ...
 *
 */
public class SearchAllegatiTipoPraticaService extends CommonService implements PddService {

	private final Logger log = LoggerFactory.getLogger(SearchAllegatiTipoPraticaService.class);
	...
	public String getName() {
		return "searchAllegatiTipoPratica";
	}
