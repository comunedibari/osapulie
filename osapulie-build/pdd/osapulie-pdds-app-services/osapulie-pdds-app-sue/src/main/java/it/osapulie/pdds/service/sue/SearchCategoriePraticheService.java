 ...
 *
 */
public class SearchCategoriePraticheService extends CommonService implements PddService {

	private final Logger log = LoggerFactory.getLogger(SearchCategoriePraticheService.class);
	...
	public String getName() {
		return "searchCategoriePratiche";
	}
