 ...
 *
 */
public class SearchComuniService extends CommonService implements PddService {

	private final Logger log = LoggerFactory.getLogger(SearchComuniService.class);
