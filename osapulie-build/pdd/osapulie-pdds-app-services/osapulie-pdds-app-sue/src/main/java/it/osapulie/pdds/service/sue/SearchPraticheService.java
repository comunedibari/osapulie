 ...
 *
 */
public class SearchPraticheService extends CommonService implements PddService {

	private final Logger log = LoggerFactory.getLogger(SearchPraticheService.class);
