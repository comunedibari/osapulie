 ...
 *
 */
public class SearchPraticheWebService extends CommonService implements PddService {

	private final Logger log = LoggerFactory.getLogger(SearchPraticheWebService.class);
