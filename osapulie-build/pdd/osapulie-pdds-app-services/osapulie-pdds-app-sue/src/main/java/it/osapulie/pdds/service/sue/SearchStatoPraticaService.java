 ...
 *
 */
public class SearchStatoPraticaService extends CommonService implements PddService {

	private final Logger log = LoggerFactory.getLogger(SearchStatoPraticaService.class);
