 ...
 *
 */
public class SearchTipoImmobileService extends CommonService implements PddService {

	private final Logger log = LoggerFactory.getLogger(SearchTipoImmobileService.class);
