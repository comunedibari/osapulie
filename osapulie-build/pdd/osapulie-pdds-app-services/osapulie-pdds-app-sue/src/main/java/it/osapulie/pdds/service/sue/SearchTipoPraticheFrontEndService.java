 ...
 *
 */
public class SearchTipoPraticheFrontEndService extends CommonService implements PddService {

	private final Logger log = LoggerFactory.getLogger(SearchTipoPraticheFrontEndService.class);
	...
	public String getName() {
		return "searchTipoPraticheFrontEnd";
	}
}
