 ...
 *
 */
public class UploadAllegatiToPraticaService extends CommonService implements PddService {

	private final Logger log = LoggerFactory.getLogger(UploadAllegatiToPraticaService.class);
	...
	public String getName() {
		return "uploadAllegatiToPratica";
	}
