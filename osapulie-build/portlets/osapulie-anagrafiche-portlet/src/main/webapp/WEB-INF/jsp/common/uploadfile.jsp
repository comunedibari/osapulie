<form:form modelAttribute="uploadItem" action="${uploadDichiarazioneUrl}" method="post"	enctype="multipart/form-data">
	<fieldset>
		...
		<c:choose>
			...
			<%-- 
			   <c:if test="${firma == true}">
					<br/>
					<div class="descriptionDiv">
						<spring:message code="label.dich" />
					</div>
					<br/>
				</c:if>	--%>
				<fieldset>
				...
				<div class="container_pulsante">
					<input type="submit" id="inviaDichiarazioneButton" name="invia" value="Invia" />
					<span class="spacer"></span>
					<a href="<portlet:renderURL portletMode="view"/>" class="custom_pulsante"><spring:message code="button.annulla" /></a>
				</div>
			</c:when>
			<c:otherwise>	
				<div class="descriptionDiv">
					<spring:message code="label.selezionaNumeroAllegati" />
				</div>
				<br/>
