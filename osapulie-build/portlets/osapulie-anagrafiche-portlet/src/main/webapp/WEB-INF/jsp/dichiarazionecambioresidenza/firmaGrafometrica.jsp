...
<div class="mainDiv editDelega">
	<fieldset>
	 		...
	 		<%-- <form:hidden path="codDelegante" />
	 		<form:hidden path="firmaGrafometrica" />
	 		<form:hidden path="firmaGrafometricaBase64" id="stringFirma" /> --%>
		 	...
		 	<table class="genericTable" style="width: 100%">
				<tr style="display: block;width:100%">
		 			<td colspan="2" style="width: 100%;">
		 				...
		 				<div>
						<form:errors path="firmaGrafometricaBase64" cssStyle="color:red" />
						</div>
		 			</td>
		 		</tr>
