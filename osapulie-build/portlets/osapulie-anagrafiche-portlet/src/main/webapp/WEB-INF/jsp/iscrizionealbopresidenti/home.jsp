...
<portlet:actionURL var="iscrizioneAlboPresidentiUrl">
	<portlet:param name="ope" value="iscrizioneAlboPresidenti" />
</portlet:actionURL>
...
<div class="mainDiv">
	<div class="container_pulsante">
		...
		<a class="custom_pulsante" href="${iscrizioneAlboPresidentiUrl}"><spring:message code="button.dichiarazione" /></a>
