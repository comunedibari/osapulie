		...
		<tr>
			...
			e)  ${datiPratica.campiaggiuntivi[65].campiAggiuntivi.label}:<br/>
				...
				<ul>
					...
					<li>ad effettuare l'aggiornamento catastale nel termine di cui all'art. 34-quinquies, comma 2, lettera b), del D.L 10 gennaio 2006, n. 4, convertito, con modificazioni, dalla Legge 9 marzo 2006, n. 80, nei casi previsti dalle vigenti disposizioni;</li>
