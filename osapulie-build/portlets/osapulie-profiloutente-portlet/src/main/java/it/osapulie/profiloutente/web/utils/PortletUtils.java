 ...
 *******************************************************************************/
package it.osapulie.profiloutente.web.utils;
...
public class PortletUtils {
	...
	public static Date getDateFromLiferayInputDate(PortletRequest request, int elementPosition, String dayParam, String monthParam, String yearParam) {
		...
		Calendar calendar = new GregorianCalendar();
		try {
			calendar.set(Integer.parseInt(request.getParameterValues(yearParam)[elementPosition]), Integer.parseInt(request.getParameterValues(monthParam)[elementPosition]), Integer.parseInt(request.getParameterValues(dayParam)[elementPosition]));
		}
		catch (Exception e) {
			calendar.setTime(new Date());
			calendar.set(calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH));
