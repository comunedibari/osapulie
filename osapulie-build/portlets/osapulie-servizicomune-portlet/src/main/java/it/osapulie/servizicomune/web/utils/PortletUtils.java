...
public class PortletUtils {
	...
	/**
	 * Conta il numero dei servizi attivi nella lista passata in input.
	 *
	 * @param servizi
	 * @return
	 */
	public static int countActiveServices(List<Servizio> servizi) {
	...
	/**
	 * Conta il numero dei servizi per cui è richiesta l'autenticazione forte nella lista passata in
	 * input.
	 *
	 * @param servizi
	 * @return
	 */
	public static int countStrongAutenticationServices(List<Servizio> servizi) {

		int serviziAutenticazioneForte = 0;
		if (servizi != null) {
			for (Servizio servizio : servizi) {
				if (servizio.isAutenticazioneForte()) {
					serviziAutenticazioneForte++;
				}
			}
		}

		return serviziAutenticazioneForte;
	}
}
