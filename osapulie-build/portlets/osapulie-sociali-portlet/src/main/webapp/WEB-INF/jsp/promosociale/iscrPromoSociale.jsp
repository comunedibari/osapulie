...
<div class="mainDiv iscrizionePromoSociale">
	...
	<form:form id="${idForm}" action="${dichiarazioneUrlGenera}" method="post" commandName="datiPromoSociale">
		...
		<c:if test="${empty download}">
			...
			<fieldset>	
				...
				<table class="genericTable">
					<tr>
						<td width="50%">
							<label><spring:message code="label.artSedeLegale" />: </label>
						</td>
						<td>
							<form:input path="artSedeLegale" /> 
							<div><form:errors path="artSedeLegale" cssStyle="color:red"/></div>
						</td>	  
					</tr>
					<tr>
						<td width="50%">
							<label><spring:message code="label.artRappLegale" />: </label>
						</td>
						<td>
							<form:input path="artRappLegale" /> 
							<div><form:errors path="artRappLegale" cssStyle="color:red"/></div>
						</td>	  
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td>
							<label><spring:message code="label.artReinvAvanzi" />: </label>
						</td>
						<td>
							<form:input path="artReinvAvanzi" /> 
							<div><form:errors path="artReinvAvanzi" cssStyle="color:red"/></div> 	
						</td>	  
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td>
							<label><spring:message code="label.artUtilSociale" />: </label>
						</td>
						<td>
							<form:input path="artUtilSociale" /> 
							<div><form:errors path="artUtilSociale" cssStyle="color:red"/></div> 	
						</td>	  
					</tr>
				</table>
			</fieldset>
