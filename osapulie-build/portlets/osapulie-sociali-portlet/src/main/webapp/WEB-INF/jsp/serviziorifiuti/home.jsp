...
<portlet:actionURL var="servizioRifiutiUrl">
	<portlet:param name="action" value="getServizioRifiutiForm" />
</portlet:actionURL>
...
<div class="mainDiv">
	<div class="container_pulsante">
		<a class="custom_pulsante" href="${servizioRifiutiUrl}"><spring:message code="button.dichiarazione" /></a>
