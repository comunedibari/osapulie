...
public class DatiCalcoloImuImmobile extends DatiCalcoloImuRiepilogo {
	...
	// Index dell'immobile selezionato. Serve per la validazione.
	String index;

	// Rendita catastale non rivalutata visualizzata nella table
	String valoreimtable;
	...
	public String getValoreimtable() {
		return valoreimtable;
	}

	public void setValoreimtable(String valoreimtable) {
		this.valoreimtable = valoreimtable;
	}
