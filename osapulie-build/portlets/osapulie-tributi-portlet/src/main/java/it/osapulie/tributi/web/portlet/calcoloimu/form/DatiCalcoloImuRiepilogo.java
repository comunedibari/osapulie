 ...
 * 
 */
public class DatiCalcoloImuRiepilogo implements Serializable {
	...
	public String getImpostaImu() {
		return impostaImu;
	}

	public void setImpostaImu(String impostaImu) {
		this.impostaImu = impostaImu;
	}
