package it.osapulie.tributi.web.portlet.rimborsoaffissioni.validator;
...
/**
 * Form validator per {@link DatiRimborsoAffissioni}.
 * 
 * @author Maria Michela Birtolo
 */
@Component("DatiRimborsoAffissioniValidator")
public class DatiRimborsoAffissioniValidator implements Validator {

	@Override
	public boolean supports(Class<?> clazz) {
		return DatiRimborsoAffissioni.class.isAssignableFrom(clazz);
	}
	...
	public void validate(Object target, Errors errors) {
		DatiRimborsoAffissioni dati = (DatiRimborsoAffissioni) target;
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "num1", "NotEmpty.field.required");
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "dim1", "NotEmpty.field.required");
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "gg1", "NotEmpty.field.required");
