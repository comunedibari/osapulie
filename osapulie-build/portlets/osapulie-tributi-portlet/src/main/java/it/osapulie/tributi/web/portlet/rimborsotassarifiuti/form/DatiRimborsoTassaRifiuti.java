package it.osapulie.tributi.web.portlet.rimborsotassarifiuti.form;
...
/**
 * Classe contenente i dati per la generazione della richiesta di rimborso Tassa Rifiuti
 *
 * @author Maria Michela Birtolo
 * @author Gianluca Pindinelli
 *
 */
public class DatiRimborsoTassaRifiuti extends DatiRimborsoGenerali implements Serializable {
	...
	/**
	 * @param tipoTassa the tipoTassa to set
	 */
