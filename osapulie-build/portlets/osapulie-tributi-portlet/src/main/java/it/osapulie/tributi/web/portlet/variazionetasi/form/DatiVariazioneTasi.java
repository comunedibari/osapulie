package it.osapulie.tributi.web.portlet.variazionetasi.form;
...
/**
 * Classe contenente i dati per la generazione della variazione TASI.
 *
 * @author Maria Michela Birtolo
 * @author Antonio Abbinante
 *
 */
public class DatiVariazioneTasi implements Serializable {
	...
	List<PosizioniTassaImmobiliDichiarazione> posizioni = new ArrayList<DatiDichiarazioneTassaImmobili.PosizioniTassaImmobiliDichiarazione>();
