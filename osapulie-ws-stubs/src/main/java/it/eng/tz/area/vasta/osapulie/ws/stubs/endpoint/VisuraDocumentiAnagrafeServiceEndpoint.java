...
import it.eng.tz.area.vasta.osapulie.ws.stubs.visuraDocumentiAnagrafeService.*;

public class VisuraDocumentiAnagrafeServiceEndpoint {
	
	private static final Logger logger = LoggerFactory.getLogger(VisuraDocumentiAnagrafeServiceEndpoint.class.getName());
