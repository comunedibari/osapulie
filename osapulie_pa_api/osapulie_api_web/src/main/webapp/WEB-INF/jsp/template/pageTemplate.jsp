	...
	<div id="wrapper">
		<div class="preHeader container-fluid text-right">
			<c:if test="${not empty utenteLoggato }">
				<p><spring:message code="msgs.welcome.msg" /> ${utenteLoggato.nome} ${utenteLoggato.cognome}</p> 
						...
						<ul class="dropdown-menu dropdown-user">
							...
							<li>
								<a href="<spring:url value="/pages/logout?logout" />">
									...
									<spring:message code="msgs.user.profile.logout" />
								</a>
							</li>
						</ul> <!-- /.dropdown-user --></li>
					<!-- /.dropdown -->
	    ...
	    <div class="modal-dialog">
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
	                <p><spring:message code="msgs.session.dialog.body"/></p>
	                <div class="progress">
	            ...
	            <div class="modal-footer">
	                <button id="jitp-warn-logout" type="button" class="btn btn-default"><spring:message code="msgs.user.profile.logout" /></button>
	                <button id="jitp-warn-alive" type="button" class="btn btn-primary"><spring:message code="msgs.session.dialog.extend"/></button>
	            </div>
	        </div>
	    </div>
	</div>	
